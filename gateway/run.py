...
class GatewayRunner:
    ...
    def _create_adapter(
        ...
        if platform == Platform.TELEGRAM:
            ...
            from gateway.platforms.viche import VicheAdapter, check_viche_requirements

            if not check_viche_requirements():
                logger.warning(
                    "Viche: websockets/aiohttp not installed or VICHE_ENABLED not set"
                )
                return None
            return VicheAdapter(config)
